...
// updateFood()
//
// move the food object around
function updateFood() {

  food.vx = map(random(), 0, 1, -FOOD_MAX_SPEED, FOOD_MAX_SPEED);
  food.vy = map(random(), 0, 1, -FOOD_MAX_SPEED, FOOD_MAX_SPEED);
